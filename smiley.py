...
sense.set_pixel(0,3,black)
sense.set_pixel(2,0,black)
sense.set_pixel(1,1,black)
sense.set_pixel(0,2,black)
sense.set_pixel(0,3,black)
sense.set_pixel(0,4,black)
sense.set_pixel(0,5,black)
sense.set_pixel(1,6,black)
sense.set_pixel(2,7,black)
sense.set_pixel(3,7,black)
sense.set_pixel(4,7,black)
sense.set_pixel(5,7,black)
sense.set_pixel(6,6,black)
sense.set_pixel(7,5,black)
sense.set_pixel(7,4,black)
sense.set_pixel(7,3,black)
sense.set_pixel(7,2,black)
sense.set_pixel(7,5,black)
sense.set_pixel(6,1,black)
sense.set_pixel(5,0,black)
